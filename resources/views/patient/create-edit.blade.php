                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ url('pacientes') }}">
                        ...
                        <div class="flex w-full space-x-5">
                            ...
                            <div class="w-1/2">
                                <x-input-label for="cpf" :value="__('CPF')" />
                                <x-text-input id="cpf" name="cpf" type="date" class="mt-1 block w-full" :value="old('cpf', $patient->cpf)" required autofocus autocomplete="cpf" />
                                <x-input-error class="mt-2" :messages="$errors->get('surname')" />
                            </div>
                            
                            <div class="w-1/2">
                                <x-input-label for="email" :value="__('Email')" />
                                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full" :value="old('email', $patient->email)" required autofocus autocomplete="email" />
                                <x-input-error class="mt-2" :messages="$errors->get('phone')" />
                            </div>
